...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OverrideFile) DeepCopyInto(out *OverrideFile) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OverrideFile.
func (in *OverrideFile) DeepCopy() *OverrideFile {
	if in == nil {
		return nil
	}
	out := new(OverrideFile)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkspaceParameters) DeepCopyInto(out *WorkspaceParameters) {
	*out = *in
	...
	if in.OverrideFiles != nil {
		in, out := &in.OverrideFiles, &out.OverrideFiles
		*out = make([]OverrideFile, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
